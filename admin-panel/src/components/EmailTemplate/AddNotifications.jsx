...
import { newNotification } from "../../services/notification.service";
...
function NotificationsAdd() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data: res } = await newNotification(obj);
      if (res) {
        alert(res.message);
      }
    } catch (error) {
      ...
      <section className="product-category" style={{ minHeight: "75vh" }}>
        <div className="container-fluid p-0">
          <form action="#" className="form">
            <h5 className="blue-1 mb-4">Add New Notification</h5>
            <div className="row">
              <div className="col-12 col-md-8">
                <DashboardBox>
                  <div className="row">
                    <h5 className="blue-1 mb-4">Notification</h5>
