            ...
            <div className="border-bottom pb-3 mb-4 row">
              ...
              <div className="col-12 col-md-6 mb-3">
                ...
                {brands && brands.length > 0 && (
                  <Select onChange={handleBrandSelection} defaultInputValue={selectedBrandId} value={brandObj} options={brands && brands.length > 0 ? brands.map((el) => ({ ...el, label: el.name, value: el._id })) : []} />
                )}
              </div>
        ...
        <div className="col-12 col-md-4">
          <DashboardBox>
            ...
            <div className="border-bottom pb-3 mb-4 row">
              ...
              <div className="col-12 mb-3">
                <label>
                  Video Link<span className="red">*</span>
                </label>
