...
export default function PriceSummery(props: any) {
  const [showguests, SetShowGuests1] = useState(false);

  const handleshowguests = () => {
    SetShowGuests1(!showguests);
  };
      ...
      >
                       ...
                       <button
                         ...
                         onClick={() =>
                           ...
                           props.setLocationSearch({
                             ...props.locationSearch,
                             adult:
                               props.locationSearch.adult >= props.people
        ...
        {/* <ul className={style.list}>
          <li className={style.item}>
            ...
            <span className={style.price}>₹ {props.totalPrice}</span>
          </li> */}
        {/* <li className={style.item}>
                                                        <span className={style.heading}>Discount</span>
